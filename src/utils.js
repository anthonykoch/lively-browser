...
// export const PhantomList = function (items=[]) {
 ...
 * @param  {String} contents - The markdown file contents
 * @return {Array}
 */
export const parseMarkdown = (contents) => {
  const slides = contents.split(/# \*Part\*/g);
